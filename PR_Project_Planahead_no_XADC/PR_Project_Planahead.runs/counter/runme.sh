...
EAStep ngdbuild -intstyle ise -p xc7k325tffg900-2 -dd _ngo -uc "counter.ucf" "counter.edf"
EAStep map -intstyle pa -w "counter.ngd"
EAStep par -intstyle pa "counter.ncd" -w "counter_routed.ncd"
EAStep trce -intstyle ise -o "counter.twr" -v 30 -l 30 "counter_routed.ncd" "counter.pcf"
EAStep xdl -secure -ncd2xdl -nopips "counter_routed.ncd" "counter_routed.xdl"
