------------------------------------------------------------------------------
-- user_logic.vhd - entity/architecture pair (reconfigurable_peripherals)
------------------------------------------------------------------------------
--
-- ***************************************************************************
...
architecture IMP of user_logic is
  ...
  --USER signal declarations added here, as needed for user logic
	component rp
		port
			(
				reg_0 : in std_logic_vector(0 to C_SLV_DWIDTH-1);
				reg_1 : out std_logic_vector(0 to C_SLV_DWIDTH-1);
				Clk : in std_logic;
