...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\Users\ECE\Documents\PR_Project
  logical library name                       : reconfigurable_peripherials_v1_00_a
  top name                                   : reconfigurable_peripherials
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- HDL source file(s)
  ...
  hdl/vhdl/reconfigurable_peripherials.vhd
...
- XPS interface file(s)
  ...
  data/reconfigurable_peripherials_v2_1_0.mpd
  ...
  data/reconfigurable_peripherials_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/reconfigurable_peripherials.xise
  ...
  devl/projnav/reconfigurable_peripherials.tcl

    This is the TCL command line file used to generate the .xise file.

- XST synthesis file(s)

  devl/synthesis/reconfigurable_peripherials_xst.scr
  ...
  devl/synthesis/reconfigurable_peripherials_xst.prj
...
- Driver source file(s)
  ...
  src/reconfigurable_peripherials.h
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/reconfigurable_peripherials_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/reconfigurable_peripherials_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	C:\Users\ECE\Documents\PR_Project\C:\Xilinx\14.6\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
